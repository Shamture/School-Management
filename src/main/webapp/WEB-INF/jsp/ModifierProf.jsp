    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row">
                     <h2>Créer Profil Professeurs</h2>
                     <hr>
                </div>
                <!-- /.row -->
                  ...
                  <div class="col-md-8">
                    <form method="post" action="" >
                       <div class="form-group">
			             ...
			             <input id="cin" name="cin" type="text" value="${prof.cin }"  class="form-control" placeHolder="C.I.N" required="required"/>
			             
			             
			           </div>
			           <div class="form-group">
			             <label for="identifiant_uniq">Identifiant Unique</label>
			             <input id="identifiant_uniq" name="identifiant_uniq" type="text" value="${prof.identifiant_uniq }"  class="form-control" placeHolder="Identifiant Unique" required="required"/>
			             
			             
			           </div>
                       <div class="form-group">
			             <label for="nom">Nom</label>
			             <input id="nom" name="nom" type="text" value="${prof.nom }"  class="form-control" placeHolder="Nom" required="required"/>
			           ...
			           <div class="form-group">
			             <label>Prenom</label>
			             <input id="prenom" name="prenom" value="${prof.prenom }" type="text" class="form-control" placeHolder="Prenom" required="required"/>
			             
			           </div>
			           <div class="form-group">
			             <label>Adresse</label>
			             <input id="adresse" name="adresse" value="${prof.adresse }" type="text" class="form-control" placeHolder="Adresse"/>
			             
			           </div>
			           <div class="form-group">
			             <label>Email</label>
			             <input  name="email" type="email" value="${prof.email }" class="form-control" placeHolder="E-Mail" required="required"/>
			             
			           </div>
			           <div class="form-group">
			             <label>Num Telephone</label>
			            <input id="tel" name="tel" type="text" value="${prof.tel }" class="form-control" placeHolder="Num Telephone"/>
