        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="home-icon">
                      <p>
                        <a href="<c:url value="/admin/liste_contact"/>"><i class="fa fa-envelope-o fa-5x b-red" aria-hidden="true"></i></a> <span><strong>${requestScope.contacts} Nouveaux</strong> <small>Contacts</small></span>
                      </p>
                    </div>
                    </div>
                    ...
                    <div class="home-icon">
                      <p>
                        <a href="<c:url value="/admin/list_remarques"/>"><i class="fa fa-tags fa-5x b-blue" aria-hidden="true"></i></a> <span><strong>${requestScope.rmqs } Nouvelles</strong> <small>Remarques</small></span>
                      </p>
                    </div>
                    </div>
                </div>
