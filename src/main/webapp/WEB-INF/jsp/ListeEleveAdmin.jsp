...
<head>
    ...
    <title>Admin - Liste Eleves</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row">
                     <h1 class="red">Liste des eleves</h1>
                     <hr/>
                </div>
                <!-- /.row -->
				...
				<div class="row">
					<div class="col-md-12">
						<table class="table table-bordered">
							...
							<c:forEach items="${requestScope.eleves }" var="item">
								<tr id="ligne${item.idEleve }">
								    <td><i><strong><c:out value="${item.code }" /></strong></i></td>
									...
									<td><a
										href="<c:url value="/admin/modifier_eleve/${item.idEleve }"/>"
										target="_blank"><button class="btn btn-primary"><i class="fa fa-cog" aria-hidden="true"></i> Modifier</button> </a></td>
									<td><a href=""><button class="btn btn-danger deleter" id="${item.idEleve }"><i class="fa fa-trash" aria-hidden="true"></i> Supprimer</button> </a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
