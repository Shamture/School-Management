...
<head>
    ...
    <title>Admin - Liste des contacts</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row">
                     <h2 class="red">Liste des contacts</h2>
                     <br/><br/>
                </div>
                <!-- /.row -->
          ...
          <div class="panel-heading">(<c:out value="${requestScope.listContacts.size() }" />) Nouveaux Messages</div>
          ...
          <table class="table">
                      ...
                      <c:forEach items="${requestScope.listContacts }" var="item">
                        <tr>
                          <td> <c:out value="${item.email }" /> </td>
                           <td> <c:out value="${item.sujet }" /> </td>
                            <td> <a href="<c:url value="/admin/consulter_contact?id=${item.id }"/>" class="btn btn-link" target="_blank">Lire Plus >> </a> </td>
                        </tr> 
                      </c:forEach>
                    </table>
          </div>
