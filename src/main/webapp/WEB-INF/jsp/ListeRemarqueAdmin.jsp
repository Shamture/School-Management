...
<head>
    ...
    <title>Admin - Liste Remarques</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
         ...
         <div class="panel panel-primary">
          <div class="panel-heading">(<c:out value="${requestScope.rmqs.size() }" />) Nouvelles Remarques</div>
          <div class="panel-body">
           <table class="table">
             ...
             <c:forEach items="${requestScope.rmqs }" var="item">
                  ...
                  <td> <a href="<c:url value="/admin/consulterRemarque/${item.id }" />" class="btn btn-link" target="_blank">Consulter</a> </td>
                  </tr>
