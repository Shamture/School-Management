     ...
     <div class="container custom-section custom-height">
       ...
       <div class="col-md-8">
         <div class="panel panel-primary">
          <div class="panel-heading">(<c:out value="${requestScope.numAbsence }" />) Nouvelles Absences</div>
          <div class="panel-body">
           <table class="table">
             ...
             <c:forEach items="${requestScope.absences }" var="item">
              <c:choose>
                <c:when test="${item.vue==0 }">
                  <tr class="active">
                  <td><c:out value="${item.date }"/></td>
                  <td><c:out value="${item.matiere }"/></td>
