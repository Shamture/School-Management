...
<head>
    ...
    <title>Admin - Liste Professeurs</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row">
                     <h1 class="red"><strong>Liste des professeurs</strong></h1>
                     <hr/>
                </div>
                <!-- /.row -->
				...
				<div class="row">
					<div class="col-md-12">
						<table class="table table-bordered">
							...
							<c:forEach items="${requestScope.profs }" var="item">
								<tr id="ligne${item.id }">
								    <td><i><strong><c:out value="${item.cin }" /></strong></i></td>
								    <td><c:out value="${item.identifiant_uniq }" /></td>
									...
									<td><a
										href="<c:url value="/admin/modification_professeur/${item.id }"/>"
										target="_blank"><button class="btn btn-primary"><i class="fa fa-cog" aria-hidden="true"></i> Modifier</button> </a></td>
									<td><a href=""><button class="btn btn-danger deleter" id="${item.id }"><i class="fa fa-trash" aria-hidden="true"></i> Supprimer</button> </a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
