...
<head>
    ...
    <title>Contact - <c:out value="${contact.sujet }" /></title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row">
                     <h3><c:out value="${contact.sujet }" /></h3>
                     <br/><br/>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                 <div class="col-md-8">
                   <p>
                     ...
                     <c:out value="${contact.texte }" />
                     <br/><br/>
                     <strong>Date : </strong><c:out value="${contact.date }" />
                    </p>
                 </div>
                    </div><div class="row">
                    ...
                    <form method="post" action="">
                     <input type="text" name="id" value="${param.id }" class=" hidden" />
                      <div class="form-group">
                        <label>Reponse</label>
                        <textarea rows="4" cols="40" class="form-control" name="message"></textarea>
                      </div>
                      <input type="text" class="hidden" name="mail" value="${contact.email }" />
